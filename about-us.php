...
$fetch=mysqli_query($con,"select * from about_tbl");
...
?>
                                     ...
                                     <img src="../back-end/assets/images/<?php echo $res['first_img'];?>"
                        ...
                        <div class="col-6">
                            <div class="fresh-image">
                                <div>
                                   <img src="../back-end/assets/images/<?php echo $res['second_img'];?>" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="fresh-contain p-center-left">
                        <div>
                            <div class="review-title">
                                <h4>About Us</h4>
                                <h2><?php echo $res['description_z'];?></h2>
                            </div>

                            <div class="delivery-list">
                                <p class="text-content"><?php echo $res['long_description'];?></p>
                                ...
                                <ul class="delivery-box">
                                    <li>
                                        <div class="delivery-box">
                                            ...
                                            <div class="delivery-detail">
                                                <h5 class="text"><?php echo $res['description_a'];?></h5>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="delivery-box">
                                            ...
                                            <div class="delivery-detail">
                                                <h5 class="text"><?php echo $res['description_b']?></h5>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="delivery-box">
                                            ...
                                            <div class="delivery-detail">
                                                <h5 class="text"><?php echo $res['description_c'];?></h5>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="delivery-box">
                                            ...
                                            <div class="delivery-detail">
                                                <h5 class="text"><?php echo $res['description_d'];?></h5>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
    ...
    <section class="team-section section-lg-space">
        <div class="container-fluid-lg">
            <div class="about-us-title text-center">
                ...
                <h2 class="center">BAAJ,grocery team member</h2>
            </div>
            <div class="row">
                <div class="col-12">
